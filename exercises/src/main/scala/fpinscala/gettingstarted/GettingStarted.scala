...
object MyModule {
  ...
  def fib(n: Int): Int = {
        def hlpr(n : Int, p1 : Int, p2 : Int) : Int = 
            if (n == 0) p1
             else hlpr (n -1, p2, p2+p1)
...
object PolymorphicFunctions {
  ...
  def isSorted[A](as: Array[A], gt: (A,A) => Boolean): Boolean = {
    def loop(as: Array[A], gt: (A,A) => Boolean, x : Int):Boolean =  
  ...
  */
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(isSorted(Array(1,2,3,4,5),(a : Int, b : Int) => a > b))
    println("isSorted(Array(1,2,6,4,5),(a : Int, b : Int) => a > b)")
    println(isSorted(Array(1,2,6,4,5),(a : Int, b : Int) => a > b))
  }
